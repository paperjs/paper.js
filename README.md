...
<https://dynamicprogrammer.com/2014/02/18/installing-node-js-on-mac-osx/>

on OSX, [Homebrew](https://brew.sh/) is also a good option if one version of
...
For Linux see <https://nodejs.org/download/> to locate 32-bit and 64-bit nodejs
binaries as well as sources, or use NVM: <https://github.com/creationix/nvm>
...
need the Cairo Graphics library installed, see: <https://cairographics.org/>.

##### Installing Cairo and Pango on OSX:

The easiest way to install Cairo is install Homebrew
<https://brew.sh/> then issue the command:
...
(https://help.github.com/articles/about-pull-requests/) which will then be merged into the
