/*!
 * Paper.js v0.12.3-sweep-and-prune - The Swiss Army Knife of Vector Graphics Scripting.
 * http://paperjs.org/
 *
...
var PaperScope = Base.extend({
	...
	version: "0.12.3-sweep-and-prune",
...
new function() {
	...
	function getIntersections(curves1, curves2, include, matrix1, matrix2,
		...
		var length1 = curves1.length,
			...
			bounds1 = new Array(length1),
			bounds2 = self ? bounds1 : new Array(length2),
			locations = [];
		...
		var overlaps = CollisionDetection.findBoundsOverlaps(bounds1, self ? null : bounds2, epsilon);
		for (var index1 = 0; index1 < length1; index1++) {
			...
			var overlaps1 = overlaps[index1];
			if (overlaps1) {
				for (var j = 0; j < overlaps1.length; j++) {
					if (_returnFirst && locations.length)
						return locations;
					var index2 = overlaps1[j];
